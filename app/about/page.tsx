...
import { Leaf, Sun, Compass, Award, ArrowRight, ShieldCheck, HeartHandshake, Sparkles, Users } from 'lucide-react';
...
export default function AboutPage() {
  return (
    <div className="flex flex-col w-full">
      {/* 1. Hero */}
      <Hero
        title="Kisah Perjalanan & Misi Kami"
        subtitle="Menjadi berkat bagi sesama dengan menjadi mitra terbaik bagi para Chef di seluruh Indonesia."
        badge="Tentang Novio"
      ...
      <section className="py-20 px-6 sm:px-8 bg-softwhite">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-charcoal/70 text-base sm:text-lg leading-relaxed font-light">
            Hari ini, <span className="notranslate font-medium" translate="no">Novio</span> Bali dan <span className="notranslate font-medium" translate="no">Novio</span> Bandung bukan sekadar kegiatan bisnis biasa. Keduanya adalah tentang keluarga kami, jejak perjalanan hidup kami, dan harapan tulus kami untuk masa depan yang lebih cerah bagi para petani lokal Indonesia.
          </p>
        </div>
      </section>
