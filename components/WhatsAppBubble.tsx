...
export default function WhatsAppBubble() {
  ...
  return (
    ...
    >
      ...
      {!isOpen && (
        <div className="absolute right-full bottom-1/2 translate-y-1/2 mr-3.5 pointer-events-none opacity-0 group-hover:opacity-100 transition-all duration-300 translate-x-2 group-hover:translate-x-0 hidden sm:block">
